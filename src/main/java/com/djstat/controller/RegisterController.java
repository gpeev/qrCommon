...
import com.djstat.form.Register;
...
public class RegisterController
{
	...
	public final String activate(@PathVariable("key") final String key, final ModelMap modelMap)
	{
	...
	public final String list(final HttpServletRequest request)
	{
		List<UserAccount> l = userDetailsService.getUsers();
		for (int i = 0; l!=null && i < l.size(); i++)
		{
			UserAccount userAccount = l.get(i);
