package com.djstat.controller.task;
...
public class MailTask
{
	...
	public final void sendActivationMail(@RequestParam final String username, @RequestParam final String locale, final HttpServletResponse response)
	{
